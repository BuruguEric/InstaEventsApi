...
class ExtensionOwnersAccount extends Controller
{
    /*
    *
    ...
    */
    ...
    private $Folder = 'extensions'; //Set Default Folder For html files
    private $SubFolder = '/accounts/owners'; //Set Default Sub Folder For html files and Front End Use Start with /

    private $AllowedFile = null; //Set Default allowed file extension, remember you can pass this upon upload to override default allowed file type. Allowed File Extensions Separated by | also leave null to validate using jpg|jpeg|png|doc|docx|pdf|xls|txt change this on validation function at the bottom

    private $Route = 'owners'; //If you have different route Name to Module name State it here |This wont be pluralized | set it null to use default

    private $New = 'owners/open/add'; //New User
    private $Save = 'owners/valid/save'; //Add New User
    private $Edit = 'owners/valid/update'; //Update User

    private $ModuleName = 'Owner'; //Module Nmae
