...
class CoreCustomFields extends Controller
{
    /*
    *
    ...
    */
    ...
    private $Route = 'customfields'; //If you have different route Name to Module name State it here |This wont be pluralized | set it null to use default

    private $New = 'customfields/open/add'; //New User
    private $Save = 'customfields/valid/save'; //Add New User
    private $Edit = 'customfields/valid/update'; //Update User
    ...
    public function valid($type)
    {
        ...
        if ($type == 'save') {
            ...
            $validatedData = Validator::make($formData,[
                'customfield_title' => ['required','max:200'],
            ])->validate();;
