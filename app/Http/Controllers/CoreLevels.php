...
class CoreLevels extends Controller
{
    /*
    *
    ...
    */
    ...
    private $New = 'level/open/add'; //New User
    private $Save = 'level/valid/save'; //Add New User
    private $Edit = 'level/valid/update'; //Update User

    private $ModuleName = 'level'; //Module Nmae
    ...
    public function valid($type)
    {
        ...
        if ($type == 'save') {
            ...
            $validatedData = Validator::make($formData,[
                'level_default' => ['required','min:1','max:5'],
                'level_name' => ['required','min:1','max:100'],
                'level_module' => ['required','min:1','max:5000'],
            ])->validate();;
