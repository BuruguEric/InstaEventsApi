...
class CoreAutoFields extends Controller
{
    ...
    */
    ...
    private $Folder = 'autofields'; //Set Default Folder For html files
    ...
    private $Route = 'autofields'; //If you have different route Name to Module name State it here |This wont be pluralized | set it null to use default

    private $New = 'autofields/open/add'; //New User
    private $Save = 'autofields/valid/save'; //Add New User
    private $Edit = 'autofields/valid/update'; //Update User

    private $ModuleName = 'autofields'; //Module Nmae
    ...
    public function valid($type)
    {
        ...
        if ($type == 'save') {
            ...
            $validatedData = Validator::make($formData,[
                'autofield_title' => ['required','min:1','max:200'],
                'autofield_select' => ['required','min:1','max:5000'],
            ])->validate();;
            ...
            if ($validatedData == TRUE) {
                ...
                if ($this->create($formData,$unsetData)) {
                    ...
                    return $this->index();//Redirect to Page
                }else{
        ...
        elseif ($type == 'update') {
            ...
            $validatedData = Validator::make($updateData,[
                'autofield_select' => ['required','max:5000'],
            ])->validate();;
