					    ...
					    <div class="col-md-6 col-sm-12">
					        <div class="form-group">
					            <div class="fg-line">
                                    ...
                                    <input type="text" class="form-control" name="autofield_title" id="" autocomplete="off" value="{{ old('autofield_title') }}">
					            </div>
	                            @if ($errors->has('autofield_title'))
	                                <span class="error">{{ $errors->first('autofield_title') }}</span>
	                            @endif
					        </div>
					    </div>
					    ...
					    <div class="col-md-6 col-sm-12">
					        <div class="form-group">
					            <div class="fg-line">
                                    ...
                                    <input type="text" class="form-control" name="autofield_select" id="" autocomplete="off" value="{{ old('customfield_title') }}">
					            </div>
					    ...
					    <div class="col-md-6 col-sm-12 labelItem" id="itemLabel">
					        <div class="form-group">
					            <div class="fg-line">
					                ...
					                <input type="text" class="form-control" name="autofield_label[]" id="" autocomplete="off" value="{{ old('customfield_title') }}">
					            </div>
					    ...
					    <div class="col-md-6 col-sm-12 valueItem" id="itemValue">
					        <div class="form-group">
					            <div class="fg-line">
					                ...
					                <input type="text" class="form-control" name="autofield_value[]" id="" autocomplete="off" value="{{ old('customfield_title') }}">
					            </div>
